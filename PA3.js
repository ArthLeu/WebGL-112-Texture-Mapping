...
var posZ, negZ, posY, negY, negX, posX;
			
function setupCubeMap() {

	/* pathList = ["skybox/pos-z.png", "skybox/neg-z.png",
				"skybox/pos-y.png", "skybox/neg-y.png",
				"skybox/neg-x.png", "skybox/pos-x.png"]; */
				
	/* pathList = ["elbrus/pos-z.jpg", "elbrus/neg-z.jpg",
				"elbrus/pos-y.jpg", "elbrus/neg-y.jpg",
				"elbrus/neg-x.jpg", "elbrus/pos-x.jpg"]; */
				
	pathList = ["chapel/pos-z.jpg", "chapel/neg-z.jpg",
				"chapel/pos-y.jpg", "chapel/neg-y.jpg",
				"chapel/neg-x.jpg", "chapel/pos-x.jpg"];
	...
	posZ = new Image();
	posZ.onload = function() { handleTextureLoaded(posZ, cubeTexture, gl.TEXTURE_CUBE_MAP_POSITIVE_Z); }
	posZ.src = pathList[0];
	
	negZ = new Image();
	negZ.onload = function() { handleTextureLoaded(negZ, cubeTexture, gl.TEXTURE_CUBE_MAP_NEGATIVE_Z); }
	negZ.src = pathList[1];
	
	posY = new Image();
	posY.onload = function() { handleTextureLoaded(posY, cubeTexture, gl.TEXTURE_CUBE_MAP_POSITIVE_Y); }
	posY.src = pathList[2];
	
	
	negY = new Image();
	negY.onload = function() { handleTextureLoaded(negY, cubeTexture, gl.TEXTURE_CUBE_MAP_NEGATIVE_Y); }
	negY.src = pathList[3];
	
	
	negX = new Image();
	negX.onload = function() { handleTextureLoaded(negX, cubeTexture, gl.TEXTURE_CUBE_MAP_NEGATIVE_X); }
	negX.src = pathList[4];
	
	posX = new Image();
	posX.onload = function() { handleTextureLoaded(posX, cubeTexture, gl.TEXTURE_CUBE_MAP_POSITIVE_X); }
	posX.src = pathList[5];
